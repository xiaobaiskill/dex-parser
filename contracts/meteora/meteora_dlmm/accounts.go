...
type BinArrayBitmapExtension struct {
	LbPair ag_solanago.PublicKey `json:"-"`
...
var ClaimFeeOperatorDiscriminator = [8]byte{166, 48, 134, 86, 34, 200, 188, 150}

func (obj ClaimFeeOperator) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(ClaimFeeOperatorDiscriminator[:], false)
	if err != nil {
		return err
	}
...
func (obj *ClaimFeeOperator) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		...
		if !discriminator.Equal(ClaimFeeOperatorDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
type LbPair struct {
	...
	// Token X mint
	TokenXMint ag_solanago.PublicKey `json:"tokenXMint"`

	// Token Y mint
	TokenYMint ag_solanago.PublicKey `json:"tokenYMint"`

	// LB token X vault
	ReserveX ag_solanago.PublicKey `json:"reserveX"`

	// LB token Y vault
	ReserveY ag_solanago.PublicKey `json:"reserveY"`
	...
	// Oracle pubkey
	Oracle ag_solanago.PublicKey `json:"oracle"`
	...
	PreActivationSwapAddress ag_solanago.PublicKey `json:"preActivationSwapAddress"`

	// Base keypair. Only required for permission pair
	BaseKey ag_solanago.PublicKey `json:"baseKey"`
	...
	// Pool creator
	Creator ag_solanago.PublicKey `json:"creator"`
...
var PresetParameter2Discriminator = [8]byte{171, 236, 148, 115, 162, 113, 222, 174}

func (obj PresetParameter2) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(PresetParameter2Discriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `BinStep` param:
...
func (obj *PresetParameter2) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		...
		if !discriminator.Equal(PresetParameter2Discriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
