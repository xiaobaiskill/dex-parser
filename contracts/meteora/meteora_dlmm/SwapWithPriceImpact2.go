...
// SwapWithPriceImpact2 is the `swapWithPriceImpact2` instruction.
...
func (inst *SwapWithPriceImpact2) SetAmountIn(amountIn uint64) *SwapWithPriceImpact2 {
	inst.AmountIn = &amountIn
	return inst
}

// SetActiveId sets the "activeId" parameter.
func (inst *SwapWithPriceImpact2) SetActiveId(activeId int32) *SwapWithPriceImpact2 {
	inst.ActiveId = &activeId
	return inst
}

// SetMaxPriceImpactBps sets the "maxPriceImpactBps" parameter.
func (inst *SwapWithPriceImpact2) SetMaxPriceImpactBps(maxPriceImpactBps uint16) *SwapWithPriceImpact2 {
	inst.MaxPriceImpactBps = &maxPriceImpactBps
	return inst
}

// SetRemainingAccountsInfo sets the "remainingAccountsInfo" parameter.
func (inst *SwapWithPriceImpact2) SetRemainingAccountsInfo(remainingAccountsInfo RemainingAccountsInfo) *SwapWithPriceImpact2 {
...
func NewSwapWithPriceImpact2Instruction(
	...
	program ag_solanago.PublicKey) *SwapWithPriceImpact2 {
	return NewSwapWithPriceImpact2InstructionBuilder().
		SetAmountIn(amountIn).
		SetActiveId(activeId).
		SetMaxPriceImpactBps(maxPriceImpactBps).
