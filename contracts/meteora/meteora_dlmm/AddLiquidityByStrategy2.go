...
// AddLiquidityByStrategy2 is the `addLiquidityByStrategy2` instruction.
...
func (inst *AddLiquidityByStrategy2) SetLiquidityParameter(liquidityParameter LiquidityParameterByStrategy) *AddLiquidityByStrategy2 {
	inst.LiquidityParameter = &liquidityParameter
	return inst
}

// SetRemainingAccountsInfo sets the "remainingAccountsInfo" parameter.
func (inst *AddLiquidityByStrategy2) SetRemainingAccountsInfo(remainingAccountsInfo RemainingAccountsInfo) *AddLiquidityByStrategy2 {
...
func NewAddLiquidityByStrategy2Instruction(
	...
	program ag_solanago.PublicKey) *AddLiquidityByStrategy2 {
