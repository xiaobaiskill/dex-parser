...
func (inst *InitializeReward) SetTokenBadgeAccount(tokenBadge ag_solanago.PublicKey) *InitializeReward {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(tokenBadge)
	return inst
}

// GetTokenBadgeAccount gets the "tokenBadge" account.
func (inst *InitializeReward) GetTokenBadgeAccount() *ag_solanago.AccountMeta {
			...
			programBranch.Child(ag_format.Instruction("InitializeReward")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=10]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("    tokenBadge", inst.AccountMetaSlice.Get(3)))
