...
func (inst *WithdrawProtocolFee) SetRemainingAccountsInfo(remainingAccountsInfo RemainingAccountsInfo) *WithdrawProtocolFee {
			...
			programBranch.Child(ag_format.Instruction("WithdrawProtocolFee")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=12]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("claimFeeOperator", inst.AccountMetaSlice.Get(7)))
						accountsBranch.Child(ag_format.Meta("        operator", inst.AccountMetaSlice.Get(8)))
						accountsBranch.Child(ag_format.Meta("   tokenXProgram", inst.AccountMetaSlice.Get(9)))
						accountsBranch.Child(ag_format.Meta("   tokenYProgram", inst.AccountMetaSlice.Get(10)))
