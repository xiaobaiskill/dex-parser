...
// RemoveLiquidityByRange2 is the `removeLiquidityByRange2` instruction.
...
func (inst *RemoveLiquidityByRange2) SetFromBinId(fromBinId int32) *RemoveLiquidityByRange2 {
	inst.FromBinId = &fromBinId
	return inst
}

// SetToBinId sets the "toBinId" parameter.
func (inst *RemoveLiquidityByRange2) SetToBinId(toBinId int32) *RemoveLiquidityByRange2 {
	inst.ToBinId = &toBinId
	return inst
}

// SetBpsToRemove sets the "bpsToRemove" parameter.
func (inst *RemoveLiquidityByRange2) SetBpsToRemove(bpsToRemove uint16) *RemoveLiquidityByRange2 {
	inst.BpsToRemove = &bpsToRemove
	return inst
}

// SetRemainingAccountsInfo sets the "remainingAccountsInfo" parameter.
func (inst *RemoveLiquidityByRange2) SetRemainingAccountsInfo(remainingAccountsInfo RemainingAccountsInfo) *RemoveLiquidityByRange2 {
...
func NewRemoveLiquidityByRange2Instruction(
	...
	program ag_solanago.PublicKey) *RemoveLiquidityByRange2 {
