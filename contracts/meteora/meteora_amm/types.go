...
type ConstantProduct uint8

func (obj ConstantProduct) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	return nil
}

func (obj *ConstantProduct) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	return nil
}

func (_ *ConstantProduct) isNewCurveType() {}
...
func (_ *ConstantProduct) isCurveType() {}
