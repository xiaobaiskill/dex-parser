...
func (inst *AddImbalanceLiquidity) SetMinimumPoolTokenAmount(minimumPoolTokenAmount uint64) *AddImbalanceLiquidity {
	inst.MinimumPoolTokenAmount = &minimumPoolTokenAmount
	return inst
}

// SetTokenAAmount sets the "tokenAAmount" parameter.
func (inst *AddImbalanceLiquidity) SetTokenAAmount(tokenAAmount uint64) *AddImbalanceLiquidity {
	inst.TokenAAmount = &tokenAAmount
	return inst
}

// SetTokenBAmount sets the "tokenBAmount" parameter.
func (inst *AddImbalanceLiquidity) SetTokenBAmount(tokenBAmount uint64) *AddImbalanceLiquidity {
