...
func (inst *InitializePermissionlessPool) SetCurveType(curveType CurveType) *InitializePermissionlessPool {
	inst.CurveType = curveType
	return inst
}

// SetTokenAAmount sets the "tokenAAmount" parameter.
func (inst *InitializePermissionlessPool) SetTokenAAmount(tokenAAmount uint64) *InitializePermissionlessPool {
	inst.TokenAAmount = &tokenAAmount
	return inst
}

// SetTokenBAmount sets the "tokenBAmount" parameter.
func (inst *InitializePermissionlessPool) SetTokenBAmount(tokenBAmount uint64) *InitializePermissionlessPool {
...
func (obj *InitializePermissionlessPool) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `CurveType`:
	{
		...
		switch tmp.Enum {
		case 0:
			obj.CurveType = (*ConstantProduct)(&tmp.Enum)
		case 1:
