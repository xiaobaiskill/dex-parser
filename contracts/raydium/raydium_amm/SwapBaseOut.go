...
func (inst *SwapBaseOut) SetUerSourceTokenAccountAccount(uerSourceTokenAccount ag_solanago.PublicKey) *SwapBaseOut {
...
func (inst *SwapBaseOut) GetUerSourceTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(15)
}

// SetUerDestinationTokenAccountAccount sets the "uerDestinationTokenAccount" account.
func (inst *SwapBaseOut) SetUerDestinationTokenAccountAccount(uerDestinationTokenAccount ag_solanago.PublicKey) *SwapBaseOut {
...
func (inst *SwapBaseOut) GetUerDestinationTokenAccountAccount() *ag_solanago.AccountMeta {
...
func (inst SwapBaseOut) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: Instruction_SwapBaseOut,
	}}
}
